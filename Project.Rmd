...
plot(res.acp, choix="ind", axes = c(1,2), invisible="quali", habillage="Glazing.area.distr")
plot(res.acp, choix="ind", axes = c(2,3), invisible="quali", habillage="Glazing.area.distr")
plot(res.acp, choix="ind", axes = c(1,3), invisible="quali", habillage="Glazing.area.distr")

plot(res.acp, choix="ind", axes = c(1,2), invisible="quali", habillage="orientation")
plot(res.acp, choix="ind", axes = c(2,3), invisible="quali", habillage="orientation")
plot(res.acp, choix="ind", axes = c(1,3), invisible="quali", habillage="orientation")
```
...
tau_min = cv.glmnet(x = expli, y = eng, family = "gaussian", alpha = 0, lambda = tau_seq, type.measure=c("mse"), intercept = F)$lambda.min
...
```{r}
fitlasso <- glmnet(x = expli, y = eng, family = "gaussian", alpha = 1, lambda = tau_seq, intercept = F)
